...
type NetworkProtocol interface {
	...
	//
	// TODO(gvisor.dev/issues/4068): Remove this once the TransportDispatcher
	// lets its callers know whether or not a transport layer packet was handled.
...
type LinkEndpoint interface {
	...
	//
	// Attach will be called with a nil dispatcher if the endpoint's associated
